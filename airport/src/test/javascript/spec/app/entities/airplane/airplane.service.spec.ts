...
describe('Service Tests', () => {
  describe('Airplane Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(AirplaneService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Airplane(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Airplane', () => {
        ...
        service.create(new Airplane()).subscribe(resp => (expectedResult = resp.body));
